...
arcpy.conversion.FeatureClassToFeatureClass(in_features=tracks_in,       out_path=out_fgdb, out_name='tracks',
	...
	start_time "start_time" true false false 50 Double 0 0, First, #, {tracks_in}, start_time, -1, -1;
	end_time   "end_time"   true false false 50 Double 0 0, First, #, {tracks_in}, end_time,   -1, -1;
